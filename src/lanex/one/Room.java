...
public class Room {
	...
	public void render(Graphics g) {
		...
		door.setRotation(0);
		g.drawImage(door, 335, 0); // TOP
		door.setRotation(180);
		g.drawImage(door, 335, 670); // BOTTOM
		door.setRotation(270);
		g.drawImage(door, 0, 335); // LEFT
		door.setRotation(90);
		g.drawImage(door, 670, 335); // RIGHT
	...
	public void addItem(float x, float y) {
		...
		if (str == 0)
			...
			items.add(new BuffItem(x,y, 20, "potion.png", ItemTypes.HEALTH, 50f));
		else if (str == 2)
